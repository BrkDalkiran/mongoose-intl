    ...
    schema.eachPath(function (path, schemaType) {
        ...
        schema.virtual(path)
            .get(function () {
				...
				const defaultLanguage = this.schema.options.mongooseIntl.defaultLanguage
                if (langSubDoc.hasOwnProperty(defaultLanguage)) {
                    return langSubDoc[defaultLanguage];
                }
            ...
            .set(function (value) {
                ...
                if (typeof value === 'object' && value !== null) {
                    ...
                    languages.forEach(function (lang) {
                        if (value[lang] === undefined) { return; }
